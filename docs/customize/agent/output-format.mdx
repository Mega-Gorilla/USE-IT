...
See all helper methods in the [AgentHistoryList source code](https://github.com/Mega-Gorilla/USE-IT/blob/main/browser_use/agent/views.py#L301).

## Structured Output

For structured output, use the `output_model_schema` parameter with a Pydantic model. [Example](https://github.com/Mega-Gorilla/USE-IT/blob/main/examples/features/custom_output.py).
