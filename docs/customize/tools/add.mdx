...
- get 2fa codes
- send emails
- Playwright integration (see [GitHub example](https://github.com/Mega-Gorilla/USE-IT/blob/main/examples/browser/playwright_integration.py))
- ...
...
```python
config = AgentConfig(task='...', llm=llm, tools=tools)
...
**[Playwright Integration Example](https://github.com/Mega-Gorilla/USE-IT/blob/main/examples/browser/playwright_integration.py)**
