...
> **Note:** This example `.env` is for your n8n deployment. Browser Use itself no longer auto-loads `.env`; keep secrets in n8n’s credential manager or export them before launching Browser Use.
