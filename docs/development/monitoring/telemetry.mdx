...
You can disable telemetry by either editing `config.yaml` (`telemetry.anonymized: false`) or exporting an environment variable:
...
<Note>
  ...
  Service](https://github.com/Mega-Gorilla/USE-IT/tree/main/browser_use/telemetry).
</Note>
