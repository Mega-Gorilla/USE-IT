...
Full implementation: [https://github.com/Mega-Gorilla/USE-IT/tree/main/examples/apps/msg-use](https://github.com/Mega-Gorilla/USE-IT/tree/main/examples/apps/msg-use)
