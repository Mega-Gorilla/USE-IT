...
<Note>
This demo requires USE IT v0.7.6+.
</Note>
...
Full implementation: [https://github.com/Mega-Gorilla/USE-IT/tree/main/examples/apps/ad-use](https://github.com/Mega-Gorilla/USE-IT/tree/main/examples/apps/ad-use)
